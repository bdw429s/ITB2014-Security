...
<div class="row">
    ...
    <div class="col-md-5">
    	<form method="post" action="#event.buildLink( 'main.act_login' )#" class="form-signin" role="form">
    ...
    <div class="col-md-5">
        <form method="post" action="#event.buildLink( 'main.act_register' )#" class="form-signin" role="form">
